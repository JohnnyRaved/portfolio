/**
 * @file portfolio.js
 * Created by john varney on 5/17/2016
 *   - Displays a code portfolio to showcase coding expertise.
 *  @author John Varney jdvarney@(nospam).msn.com
 *
 /*/

function routeURL(page, destination) {

    if (destination === 'visit') {
        location.href = "http://jdvarney.com/pages/" + page + "/index.html";
    }
    else {
        location.href = "http://jdvarney.com/docs/" + page + ".code.pdf";
    }
}
